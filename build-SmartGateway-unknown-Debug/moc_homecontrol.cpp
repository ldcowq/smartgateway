...
#include "../SmartGateway/homecontrol/homecontrol.h"
...
QT_MOC_LITERAL(1, 12, 9), // "openlight"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "HomeControl\0openlight\0"
};
...
void HomeControl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->openlight((*reinterpret_cast< qint16(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (HomeControl::*)(qint16 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HomeControl::openlight)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject HomeControl::staticMetaObject = {
...
// SIGNAL 0
void HomeControl::openlight(qint16 _t1)
{
