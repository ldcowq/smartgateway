...
#include "../SmartGateway/monitor/monitor.h"
...
QT_MOC_LITERAL(1, 8, 13), // "stopSubThread"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "Monitor\0stopSubThread\0"
};
...
void Monitor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->stopSubThread(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Monitor::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Monitor::stopSubThread)) {
                *result = 0;
                return;
            }
        }
