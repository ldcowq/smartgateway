...
#include "../SmartGateway/video/customslider.h"
...
QT_MOC_LITERAL(1, 13, 17), // "customSliderClick"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "CustomSlider\0customSliderClick\0"
};
...
void CustomSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->customSliderClick(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CustomSlider::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomSlider::customSliderClick)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomSlider::customSliderClick()
{
