...
#include "../SmartGateway/video/playerslider.h"
...
QT_MOC_LITERAL(1, 13, 25), // "sliderValueChangedByVideo"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 19) // "playerSliderClicked"

    },
    "PlayerSlider\0sliderValueChangedByVideo\0"
    "\0playerSliderClicked"
};
...
void PlayerSlider::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sliderValueChangedByVideo((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        case 1: _t->playerSliderClicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PlayerSlider::*)(qint64 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayerSlider::sliderValueChangedByVideo)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlayerSlider::playerSliderClicked)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void PlayerSlider::sliderValueChangedByVideo(qint64 _t1)
{
...
// SIGNAL 1
void PlayerSlider::playerSliderClicked()
{
